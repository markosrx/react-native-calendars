...
const KNOB_CONTAINER_HEIGHT = 20;  //0;
        ...
        <TouchableOpacity onPress={() => isClosed ? this.bounceToOpenClosedPosition(this.openHeight) : this.bounceToOpenClosedPosition(this.closedHeight)}>
          {isClosed ?
            <>
              ...
              <View style={[this.style.knob, { width: 30, justifyContent: 'center', alignSelf: 'center', top: 2 }]} />
              <View style={[this.style.knob, { width: 20, justifyContent: 'center', alignSelf: 'center', top: 4 }]} />
            </>
            :
            <>
              <View style={[this.style.knob, { width: 20, justifyContent: 'center', alignSelf: 'center', top: 0 }]} />
              <View style={[this.style.knob, { width: 30, justifyContent: 'center', alignSelf: 'center', top: 2 }]} />
              <View style={[this.style.knob, { top: 4 }]} testID={CALENDAR_KNOB} />
            </>
          }
        </TouchableOpacity>
      </View>
